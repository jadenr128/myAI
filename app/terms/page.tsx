      ...
      <div className="w-full max-w-screen-md space-y-6">
        ...
        <ol className="list-decimal list-inside space-y-4">
          ...
          <li className="text-gray-700">
            ...
            or implied. Ramsy & SmartInsure makes no guarantees regarding the accuracy, 
            completeness, timeless, or insurance-related information provided. Also, for 
            the representations or warranties regarding
            ...
            non-infringement, are expressly disclaimed. SmartInsure does not
            offer legal, financial, or professional insurance advice.
            Always verify policy details with a licensed insurance provider 
          ...
          <li className="text-gray-700">
            ...
            By using Smart Insure, You acknowledge that any data transmitted to 
            or through the Chatbot, and conversations are not encrypted or private.
          ...
          <li className="text-gray-700">
            <span className="font-semibold">No Legal, Financial, or Professional Advice:
              /span> All responses generated by SmartInsure are for informational
              purposes only and do not constitute professional legal, financial, or
              insurance advice. Users should consult a licensed insurance agent,
              attorney, or financial advisor before making any decisions. SmartInsure
              is not responsible for any losses, policy decisions, or legal actions
              taken based on chatbot responses.
          </li>
            <li className="text-gray-700">AI-Generated Content:</span>
              All responses provided by SmartInsure are generated by artificial 
              intelligence and may contain inaccuracies or omissions. Users are responsible 
              for verifying any information before relying on it. SmartInsure is NOT liable 
              for any misinformation or misinterpretation of chatbot-generated responses.
          </li>
        </ol>
      </div>
    </div>
